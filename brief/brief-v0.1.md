...
Control de inventario, stock y notificacion de los productos proximos a vencer.

**Contexto**
¿Donde y cuando Ocurre?

En las bodegas pil, o ventas de barrios.  

**Idea Inicial**
¿Que solucion imaginamos por ahora?

Hacer un monitoreo del stock y poder avisar de productos que pronto expiren.

**Usuario**
¿Quien vive esa dificultad?

el dueño de la bodega o tienda de barrio, empleados que atienden

**Tarea**
¿Que intenta hacer el usuario?

anota la cantidad de productos que tiene y ver las fechas de vencimientos. 

**Alcance**
¿Que parte pequeña abordaremos primero?

Registrar Productos,
Monitoreo y alertas configurables de la alerta para notificar,
hacer un reporte con la cantidad para pedir.

**Hipotesis**
Creemos que puede ayudar a tener un mejor cuidado con ciertos productos por que pueden llegar a expirar y provocar perdidas al negocio. Si diseñamos un sistema que permita el registro de productos, y poder mostrar el control de stock junto a los productos que estan proimo a vencer esperamos que el dueño de la bodega podria ser mas eficiente a la hora de tomar decisiones con sus productos y evitar perdidas. 
